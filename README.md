...
int main()
{
    clsString String1("Ahmed Ghanem");
    ...
    String1.ReplaceWord("Ahmed", "Sameh");
...
After Capitalizing First Letters: Ahmed Ghanem

Reversed Words: Ghanem Ahmed 

After Replace: Sameh Ghanem  
